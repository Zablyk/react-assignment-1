...
const userOutput = (props) => {
    return(
        <div className="UserOutput">
            ...
            <p onClick={props.click}>Google released a beta version in September 2002 and the official app in January 2006.[1] The initial idea was developed by {props.username}.</p>
        </div>
    );
}
